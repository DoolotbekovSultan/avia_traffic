...
class CityPickerRepository with DioExceptionHandler implements ICityPickerRepository {
  ...
  @override
  Future<Either<Failure, List<Country>>> getCountries() => executeSafely(() async {
