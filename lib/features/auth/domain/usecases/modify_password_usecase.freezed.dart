...
mixin _$ModifyPasswordParams {
  ...
  $ModifyPasswordParamsCopyWith<ModifyPasswordParams> get copyWith =>
      _$ModifyPasswordParamsCopyWithImpl<ModifyPasswordParams>(
          this as ModifyPasswordParams, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModifyPasswordParams &&
...
abstract mixin class $ModifyPasswordParamsCopyWith<$Res> {
  factory $ModifyPasswordParamsCopyWith(ModifyPasswordParams value,
          $Res Function(ModifyPasswordParams) _then) =
      _$ModifyPasswordParamsCopyWithImpl;
  @useResult
...
extension ModifyPasswordParamsPatterns on ModifyPasswordParams {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModifyPasswordParams value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String password, String confirmPassword)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ModifyPasswordParams implements ModifyPasswordParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModifyPasswordParamsCopyWith<_ModifyPasswordParams> get copyWith =>
      __$ModifyPasswordParamsCopyWithImpl<_ModifyPasswordParams>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModifyPasswordParams &&
            (identical(other.password, password) ||
                other.password == password) &&
            (identical(other.confirmPassword, confirmPassword) ||
                other.confirmPassword == confirmPassword));
...
/// @nodoc
abstract mixin class _$ModifyPasswordParamsCopyWith<$Res>
    implements $ModifyPasswordParamsCopyWith<$Res> {
  factory _$ModifyPasswordParamsCopyWith(_ModifyPasswordParams value,
          $Res Function(_ModifyPasswordParams) _then) =
      __$ModifyPasswordParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String password, String confirmPassword});
}
