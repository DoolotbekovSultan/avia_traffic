...
mixin _$ConfirmCodeParams {
  ...
  $ConfirmCodeParamsCopyWith<ConfirmCodeParams> get copyWith =>
      _$ConfirmCodeParamsCopyWithImpl<ConfirmCodeParams>(
          this as ConfirmCodeParams, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConfirmCodeParams &&
...
abstract mixin class $ConfirmCodeParamsCopyWith<$Res> {
  factory $ConfirmCodeParamsCopyWith(
          ConfirmCodeParams value, $Res Function(ConfirmCodeParams) _then) =
      _$ConfirmCodeParamsCopyWithImpl;
  @useResult
...
extension ConfirmCodeParamsPatterns on ConfirmCodeParams {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConfirmCodeParams value)? $default, {
...
class _ConfirmCodeParams implements ConfirmCodeParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConfirmCodeParamsCopyWith<_ConfirmCodeParams> get copyWith =>
      __$ConfirmCodeParamsCopyWithImpl<_ConfirmCodeParams>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConfirmCodeParams &&
            (identical(other.email, email) || other.email == email) &&
            (identical(other.code, code) || other.code == code));
  }
...
/// @nodoc
abstract mixin class _$ConfirmCodeParamsCopyWith<$Res>
    implements $ConfirmCodeParamsCopyWith<$Res> {
  factory _$ConfirmCodeParamsCopyWith(
          _ConfirmCodeParams value, $Res Function(_ConfirmCodeParams) _then) =
      __$ConfirmCodeParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String email, String code});
}
