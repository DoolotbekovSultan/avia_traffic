...
mixin _$Country {
 ...
 int get id; String get name; String get codeName; String get img; int get directions; List<City> get cities;
...
@useResult
$Res call({
 int id, String name, String codeName, String img, int directions, List<City> cities
});
...
/// Create a copy of Country
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? codeName = null,Object? img = null,Object? directions = null,Object? cities = null,}) {
...
as String,directions: null == directions ? _self.directions : directions // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String codeName,  String img,  int directions,  List<City> cities)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Country() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String codeName,  String img,  int directions,  List<City> cities)  $default,) {final _that = this;
switch (_that) {
case _Country():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String codeName,  String img,  int directions,  List<City> cities)?  $default,) {final _that = this;
switch (_that) {
case _Country() when $default != null:
return $default(_that.id,_that.name,_that.codeName,_that.img,_that.directions,_that.cities);case _:
  return null;
...
class _Country implements Country {
  const _Country({required this.id, required this.name, required this.codeName, required this.img, required this.directions, required final  List<City> cities}): _cities = cities;
...
/// Create a copy of Country
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? codeName = null,Object? img = null,Object? directions = null,Object? cities = null,}) {
