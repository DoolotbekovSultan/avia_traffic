...
mixin _$AirportModel {
 ...
 int get id; String get name;@JsonKey(name: 'code_name') String get codeName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AirportModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.codeName, codeName) || other.codeName == codeName));
}
...
/// Create a copy of AirportModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? codeName = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name, @JsonKey(name: 'code_name')  String codeName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AirportModel() when $default != null:
return $default(_that.id,_that.name,_that.codeName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name, @JsonKey(name: 'code_name')  String codeName)  $default,) {final _that = this;
switch (_that) {
case _AirportModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name, @JsonKey(name: 'code_name')  String codeName)?  $default,) {final _that = this;
switch (_that) {
case _AirportModel() when $default != null:
return $default(_that.id,_that.name,_that.codeName);case _:
  return null;
...
class _AirportModel extends AirportModel {
  const _AirportModel({required this.id, required this.name, @JsonKey(name: 'code_name') required this.codeName}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AirportModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.codeName, codeName) || other.codeName == codeName));
}
...
/// Create a copy of AirportModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? codeName = null,}) {
