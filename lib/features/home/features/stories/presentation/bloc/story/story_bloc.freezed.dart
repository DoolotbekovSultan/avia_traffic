...
class _GetStoryById implements StoryEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GetStoryByIdCopyWith<_GetStoryById> get copyWith =>
      __$GetStoryByIdCopyWithImpl<_GetStoryById>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GetStoryById &&
            (identical(other.id, id) || other.id == id));
  }
...
/// @nodoc
abstract mixin class _$GetStoryByIdCopyWith<$Res>
    implements $StoryEventCopyWith<$Res> {
  factory _$GetStoryByIdCopyWith(
          _GetStoryById value, $Res Function(_GetStoryById) _then) =
      __$GetStoryByIdCopyWithImpl;
  @override
  @useResult
  $Res call({int id});
}
...
mixin _$StoryState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is StoryState);
  }
