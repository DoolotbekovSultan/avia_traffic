...
/// @nodoc
class __$$GetStoryByIdImplCopyWithImpl<$Res>
...
class _$GetStoryByIdImpl implements _GetStoryById {
  const _$GetStoryByIdImpl(this.id);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetStoryByIdImplCopyWith<_$GetStoryByIdImpl> get copyWith =>
      __$$GetStoryByIdImplCopyWithImpl<_$GetStoryByIdImpl>(this, _$identity);
...
abstract class _GetStoryById implements StoryEvent {
  const factory _GetStoryById(final int id) = _$GetStoryByIdImpl;
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required this.story});
...
abstract class _Loaded implements StoryState {
  const factory _Loaded({required final StoryItem story}) = _$LoadedImpl;
...
abstract class _Failure implements StoryState {
