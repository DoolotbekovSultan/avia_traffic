...
mixin _$Deal {
 ...
 int get id; String get language; String get codeTo; String get codeFrom; String get slug; String get imageUrl; String get title; String get description;
...
@useResult
$Res call({
 int id, String language, String codeTo, String codeFrom, String slug, String imageUrl, String title, String description
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String language,  String codeTo,  String codeFrom,  String slug,  String imageUrl,  String title,  String description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Deal() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String language,  String codeTo,  String codeFrom,  String slug,  String imageUrl,  String title,  String description)  $default,) {final _that = this;
switch (_that) {
case _Deal():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String language,  String codeTo,  String codeFrom,  String slug,  String imageUrl,  String title,  String description)?  $default,) {final _that = this;
switch (_that) {
case _Deal() when $default != null:
return $default(_that.id,_that.language,_that.codeTo,_that.codeFrom,_that.slug,_that.imageUrl,_that.title,_that.description);case _:
  return null;
...
class _Deal implements Deal {
  const _Deal({required this.id, required this.language, required this.codeTo, required this.codeFrom, required this.slug, required this.imageUrl, required this.title, required this.description});
  

@override final  int id;
@override final  String language;
@override final  String codeTo;
@override final  String codeFrom;
