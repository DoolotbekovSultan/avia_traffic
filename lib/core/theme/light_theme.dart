...
abstract class LightTheme {
  ...
  static TextTheme get _textTheme => TextTheme(
        ...
        titleLarge:
            _t(getIt<AppTextStyles>().titleLarge, AppColors.onBackground),
        titleMedium:
            _t(getIt<AppTextStyles>().titleMedium, AppColors.onBackground),
        titleSmall:
            _t(getIt<AppTextStyles>().titleSmall, AppColors.onBackground),
        bodyLarge: _t(getIt<AppTextStyles>().bodyLarge, AppColors.onBackground),
        bodyMedium:
            _t(getIt<AppTextStyles>().bodyMedium, AppColors.onBackground),
        bodySmall: _t(getIt<AppTextStyles>().bodySmall, AppColors.neutral700),
        labelLarge:
            _t(getIt<AppTextStyles>().labelLarge, AppColors.onBackground),
        labelMedium:
            _t(getIt<AppTextStyles>().labelMedium, AppColors.onBackground),
  ...
  static TextButtonThemeData get _textButtonTheme => TextButtonThemeData(
        style: TextButton.styleFrom(
          ...
          padding:
              EdgeInsets.symmetric(horizontal: Gap.s8.w, vertical: Gap.s4.h),
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(WidgetConstants.borderRadiusMML),
          ),
        ),
      );
  ...
  static FilledButtonThemeData get _filledButtonTheme => FilledButtonThemeData(
        style: FilledButton.styleFrom(
          ...
          padding:
              EdgeInsets.symmetric(horizontal: Gap.s24.w, vertical: Gap.s12.h),
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(WidgetConstants.borderRadiusMML),
          ),
  ...
  static DialogThemeData get _dialogTheme => DialogThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius:
              BorderRadius.circular(WidgetConstants.borderRadiusLarge),
        ),
  ...
  static MaterialBannerThemeData get _bannerTheme => MaterialBannerThemeData(
        ...
        elevation: 0,
        padding:
            EdgeInsets.symmetric(horizontal: Gap.s16.w, vertical: Gap.s12.h),
  ...
  static TooltipThemeData get _tooltipTheme => TooltipThemeData(
        ...
        padding:
            EdgeInsets.symmetric(horizontal: Gap.s12.w, vertical: Gap.s8.h),
  ...
  static MenuThemeData get _menuTheme => MenuThemeData(
        style: MenuStyle(
          ...
          shape: WidgetStatePropertyAll(
            RoundedRectangleBorder(
              borderRadius:
                  BorderRadius.circular(WidgetConstants.borderRadiusML),
            ),
          ),
          padding:
              WidgetStatePropertyAll(EdgeInsets.symmetric(vertical: Gap.s4.h)),
        ),
      );
  ...
  static ScrollbarThemeData get _scrollbarTheme => ScrollbarThemeData(
        thumbColor:
            WidgetStatePropertyAll(AppColors.neutral400.withOpacity(0.8)),
